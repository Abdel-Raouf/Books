cmd_/lost+found/wasted/seq_mod/mod.mod.o := gcc -Wp,-MD,/lost+found/wasted/seq_mod/.mod.mod.o.d  -nostdinc -isystem /usr/lib/gcc/i386-redhat-linux/4.0.0/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -g -pipe -msoft-float -m32 -fno-builtin-sprintf -fno-builtin-log2 -fno-builtin-puts  -mpreferred-stack-boundary=2 -fno-unit-at-a-time -march=i686 -mtune=pentium4 -mregparm=3 -Iinclude/asm-i386/mach-default -Wdeclaration-after-statement -Wno-pointer-sign    -DKBUILD_BASENAME=mod -DKBUILD_MODNAME=mod -DMODULE -c -o /lost+found/wasted/seq_mod/mod.mod.o /lost+found/wasted/seq_mod/mod.mod.c

deps_/lost+found/wasted/seq_mod/mod.mod.o := \
  /lost+found/wasted/seq_mod/mod.mod.c \
...
/lost+found/wasted/seq_mod/mod.mod.o: $(deps_/lost+found/wasted/seq_mod/mod.mod.o)
