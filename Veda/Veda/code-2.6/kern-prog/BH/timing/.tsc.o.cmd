cmd_/root/Code/kern-prog/timing/tsc.o := gcc -Wp,-MD,/root/Code/kern-prog/timing/.tsc.o.d  -nostdinc -isystem /usr/lib/gcc/i386-redhat-linux/4.0.0/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -g -pipe -msoft-float -m32 -fno-builtin-sprintf -fno-builtin-log2 -fno-builtin-puts  -mpreferred-stack-boundary=2 -fno-unit-at-a-time -march=i686 -mtune=pentium4 -mregparm=3 -Iinclude/asm-i386/mach-default -Wdeclaration-after-statement -Wno-pointer-sign   -DMODULE -DKBUILD_BASENAME=tsc -DKBUILD_MODNAME=tsc -c -o /root/Code/kern-prog/timing/.tmp_tsc.o /root/Code/kern-prog/timing/tsc.c

deps_/root/Code/kern-prog/timing/tsc.o := \
  /root/Code/kern-prog/timing/tsc.c \
...
/root/Code/kern-prog/timing/tsc.o: $(deps_/root/Code/kern-prog/timing/tsc.o)
