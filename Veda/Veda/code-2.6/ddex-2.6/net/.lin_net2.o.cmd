cmd_/root/Code/ddex-2.6/net/lin_net2.o := gcc -Wp,-MD,/root/Code/ddex-2.6/net/.lin_net2.o.d  -nostdinc -isystem /usr/lib/gcc/i386-redhat-linux/4.0.0/include -D__KERNEL__ -Iinclude  -Wall -Wstrict-prototypes -Wno-trigraphs -fno-strict-aliasing -fno-common -ffreestanding -O2     -fomit-frame-pointer -g -pipe -msoft-float -m32 -fno-builtin-sprintf -fno-builtin-log2 -fno-builtin-puts  -mpreferred-stack-boundary=2 -fno-unit-at-a-time -march=i686 -mtune=pentium4 -mregparm=3 -Iinclude/asm-i386/mach-default -Wdeclaration-after-statement -Wno-pointer-sign   -DMODULE -DKBUILD_BASENAME=lin_net2 -DKBUILD_MODNAME=lin_net2 -c -o /root/Code/ddex-2.6/net/.tmp_lin_net2.o /root/Code/ddex-2.6/net/lin_net2.c

deps_/root/Code/ddex-2.6/net/lin_net2.o := \
  /root/Code/ddex-2.6/net/lin_net2.c \
...
/root/Code/ddex-2.6/net/lin_net2.o: $(deps_/root/Code/ddex-2.6/net/lin_net2.o)
