                               CS 61B Homework 8
                       Due 4pm Friday, November 17, 2006
...
that items are numbered from 1) without removing it.  The last method,
append(), concatenates the contents of q onto the end of this queue (in
constant time), and leaves q empty.
...
following:  remove two items from the queue of queues, merge them using
mergeSortedQueues(), and enqueue the resulting queue in the queue of queues.
